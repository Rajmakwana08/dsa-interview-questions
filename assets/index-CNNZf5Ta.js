(function(){const B=document.createElement("link").relList;if(B&&B.supports&&B.supports("modulepreload"))return;for(const U of document.querySelectorAll('link[rel="modulepreload"]'))ve(U);new MutationObserver(U=>{for(const Z of U)if(Z.type==="childList")for(const de of Z.addedNodes)de.tagName==="LINK"&&de.rel==="modulepreload"&&ve(de)}).observe(document,{childList:!0,subtree:!0});function m(U){const Z={};return U.integrity&&(Z.integrity=U.integrity),U.referrerPolicy&&(Z.referrerPolicy=U.referrerPolicy),U.crossOrigin==="use-credentials"?Z.credentials="include":U.crossOrigin==="anonymous"?Z.credentials="omit":Z.credentials="same-origin",Z}function ve(U){if(U.ep)return;U.ep=!0;const Z=m(U);fetch(U.href,Z)}})();var kl={exports:{}},vr={},Ll={exports:{}},z={};/**
 * @license React
 ...
 */var ks;function Tf(){if(ks)return z;ks=1;var D=Symbol.for("react.element"),B=Symbol.for("react.portal"),m=Symbol.for("react.fragment"),ve=Symbol.for("react.strict_mode"),U=Symbol.for("react.profiler"),Z=Symbol.for("react.provider"),de=Symbol.for("react.context"),fe=Symbol.for("react.forward_ref"),Q=Symbol.for("react.suspense"),Le=Symbol.for("react.memo"),ge=Symbol.for("react.lazy"),ee=Symbol.iterator;function Y(d){return d===null||typeof d!="object"?null:(d=ee&&d[ee]||d["@@iterator"],typeof d=="function"?d:null)}var Qe={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},He=Object.assign,X={};function H(d,y,F){this.props=d,this.context=y,this.refs=X,this.updater=F||Qe}H.prototype.isReactComponent={},H.prototype.setState=function(d,y){if(typeof d!="object"&&typeof d!="function"&&d!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,d,y,"setState")},H.prototype.forceUpdate=function(d){this.updater.enqueueForceUpdate(this,d,"forceUpdate")};function yt(){}yt.prototype=H.prototype;function at(d,y,F){this.props=d,this.context=y,this.refs=X,this.updater=F||Qe}var Je=at.prototype=new yt;Je.constructor=at,He(Je,H.prototype),Je.isPureReactComponent=!0;var we=Array.isArray,be=Object.prototype.hasOwnProperty,Se={current:null},_e={key:!0,ref:!0,__self:!0,__source:!0};function Ve(d,y,F){var R,A={},O=null,V=null;if(y!=null)for(R in y.ref!==void 0&&(V=y.ref),y.key!==void 0&&(O=""+y.key),y)be.call(y,R)&&!_e.hasOwnProperty(R)&&(A[R]=y[R]);var W=arguments.length-2;if(W===1)A.children=F;else if(1<W){for(var J=Array(W),Oe=0;Oe<W;Oe++)J[Oe]=arguments[Oe+2];A.children=J}if(d&&d.defaultProps)for(R in W=d.defaultProps,W)A[R]===void 0&&(A[R]=W[R]);return{$$typeof:D,type:d,key:O,ref:V,props:A,_owner:Se.current}}function Pt(d,y){return{$$typeof:D,type:d.type,key:y,ref:d.ref,props:d.props,_owner:d._owner}}function vt(d){return typeof d=="object"&&d!==null&&d.$$typeof===D}function $t(d){var y={"=":"=0",":":"=2"};return"$"+d.replace(/[=:]/g,function(F){return y[F]})}var st=/\/+/g;function Ae(d,y){return typeof d=="object"&&d!==null&&d.key!=null?$t(""+d.key):y.toString(36)}function et(d,y,F,R,A){var O=typeof d;(O==="undefined"||O==="boolean")&&(d=null);var V=!1;if(d===null)V=!0;else switch(O){case"string":case"number":V=!0;break;case"object":switch(d.$$typeof){case D:case B:V=!0}}if(V)return V=d,A=A(V),d=R===""?"."+Ae(V,0):R,we(A)?(F="",d!=null&&(F=d.replace(st,"$&/")+"/"),et(A,y,F,"",function(Oe){return Oe})):A!=null&&(vt(A)&&(A=Pt(A,F+(!A.key||V&&V.key===A.key?"":(""+A.key).replace(st,"$&/")+"/")+d)),y.push(A)),1;if(V=0,R=R===""?".":R+":",we(d))for(var W=0;W<d.length;W++){O=d[W];var J=R+Ae(O,W);V+=et(O,y,F,J,A)}else if(J=Y(d),typeof J=="function")for(d=J.call(d),W=0;!(O=d.next()).done;)O=O.value,J=R+Ae(O,W++),V+=et(O,y,F,J,A);else if(O==="object")throw y=String(d),Error("Objects are not valid as a React child (found: "+(y==="[object Object]"?"object with keys {"+Object.keys(d).join(", ")+"}":y)+"). If you meant to render a collection of children, use an array instead.");return V}function dt(d,y,F){if(d==null)return d;var R=[],A=0;return et(d,R,"","",function(O){return y.call(F,O,A++)}),R}function Te(d){if(d._status===-1){var y=d._result;y=y(),y.then(function(F){(d._status===0||d._status===-1)&&(d._status=1,d._result=F)},function(F){(d._status===0||d._status===-1)&&(d._status=2,d._result=F)}),d._status===-1&&(d._status=0,d._result=y)}if(d._status===1)return d._result.default;throw d._result}var re={current:null},x={transition:null},_={ReactCurrentDispatcher:re,ReactCurrentBatchConfig:x,ReactCurrentOwner:Se};function k(){throw Error("act(...) is not supported in production builds of React.")}return z.Children={map:dt,forEach:function(d,y,F){dt(d,function(){y.apply(this,arguments)},F)},count:function(d){var y=0;return dt(d,function(){y++}),y},toArray:function(d){return dt(d,function(y){return y})||[]},only:function(d){if(!vt(d))throw Error("React.Children.only expected to receive a single React element child.");return d}},z.Component=H,z.Fragment=m,z.Profiler=U,z.PureComponent=at,z.StrictMode=ve,z.Suspense=Q,z.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=_,z.act=k,z.cloneElement=function(d,y,F){if(d==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+d+".");var R=He({},d.props),A=d.key,O=d.ref,V=d._owner;if(y!=null){if(y.ref!==void 0&&(O=y.ref,V=Se.current),y.key!==void 0&&(A=""+y.key),d.type&&d.type.defaultProps)var W=d.type.defaultProps;for(J in y)be.call(y,J)&&!_e.hasOwnProperty(J)&&(R[J]=y[J]===void 0&&W!==void 0?W[J]:y[J])}var J=arguments.length-2;if(J===1)R.children=F;else if(1<J){W=Array(J);for(var Oe=0;Oe<J;Oe++)W[Oe]=arguments[Oe+2];R.children=W}return{$$typeof:D,type:d.type,key:A,ref:O,props:R,_owner:V}},z.createContext=function(d){return d={$$typeof:de,_currentValue:d,_currentValue2:d,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},d.Provider={$$typeof:Z,_context:d},d.Consumer=d},z.createElement=Ve,z.createFactory=function(d){var y=Ve.bind(null,d);return y.type=d,y},z.createRef=function(){return{current:null}},z.forwardRef=function(d){return{$$typeof:fe,render:d}},z.isValidElement=vt,z.lazy=function(d){return{$$typeof:ge,_payload:{_status:-1,_result:d},_init:Te}},z.memo=function(d,y){return{$$typeof:Le,type:d,compare:y===void 0?null:y}},z.startTransition=function(d){var y=x.transition;x.transition={};try{d()}finally{x.transition=y}},z.unstable_act=k,z.useCallback=function(d,y){return re.current.useCallback(d,y)},z.useContext=function(d){return re.current.useContext(d)},z.useDebugValue=function(){},z.useDeferredValue=function(d){return re.current.useDeferredValue(d)},z.useEffect=function(d,y){return re.current.useEffect(d,y)},z.useId=function(){return re.current.useId()},z.useImperativeHandle=function(d,y,F){return re.current.useImperativeHandle(d,y,F)},z.useInsertionEffect=function(d,y){return re.current.useInsertionEffect(d,y)},z.useLayoutEffect=function(d,y){return re.current.useLayoutEffect(d,y)},z.useMemo=function(d,y){return re.current.useMemo(d,y)},z.useReducer=function(d,y,F){return re.current.useReducer(d,y,F)},z.useRef=function(d){return re.current.useRef(d)},z.useState=function(d){return re.current.useState(d)},z.useSyncExternalStore=function(d,y,F){return re.current.useSyncExternalStore(d,y,F)},z.useTransition=function(){return re.current.useTransition()},z.version="18.3.1",z}var Ls;function Il(){return Ls||(Ls=1,Ll.exports=Tf()),Ll.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Cs;function Ff(){return Cs||(Cs=1,(function(D){function B(x,_){var k=x.length;x.push(_);e:for(;0<k;){var d=k-1>>>1,y=x[d];if(0<U(y,_))x[d]=_,x[k]=y,k=d;else break e}}function m(x){return x.length===0?null:x[0]}function ve(x){if(x.length===0)return null;var _=x[0],k=x.pop();if(k!==_){x[0]=k;e:for(var d=0,y=x.length,F=y>>>1;d<F;){var R=2*(d+1)-1,A=x[R],O=R+1,V=x[O];if(0>U(A,k))O<y&&0>U(V,A)?(x[d]=V,x[O]=k,d=O):(x[d]=A,x[R]=k,d=R);else if(O<y&&0>U(V,k))x[d]=V,x[O]=k,d=O;else break e}}return _}function U(x,_){var k=x.sortIndex-_.sortIndex;return k!==0?k:x.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var Z=performance;D.unstable_now=function(){return Z.now()}}else{var de=Date,fe=de.now();D.unstable_now=function(){return de.now()-fe}}var Q=[],Le=[],ge=1,ee=null,Y=3,Qe=!1,He=!1,X=!1,H=typeof setTimeout=="function"?setTimeout:null,yt=typeof clearTimeout=="function"?clearTimeout:null,at=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function Je(x){for(var _=m(Le);_!==null;){if(_.callback===null)ve(Le);else if(_.startTime<=x)ve(Le),_.sortIndex=_.expirationTime,B(Q,_);else break;_=m(Le)}}function we(x){if(X=!1,Je(x),!He)if(m(Q)!==null)He=!0,Te(be);else{var _=m(Le);_!==null&&re(we,_.startTime-x)}}function be(x,_){He=!1,X&&(X=!1,yt(Ve),Ve=-1),Qe=!0;var k=Y;try{for(Je(_),ee=m(Q);ee!==null&&(!(ee.expirationTime>_)||x&&!$t());){var d=ee.callback;if(typeof d=="function"){ee.callback=null,Y=ee.priorityLevel;var y=d(ee.expirationTime<=_);_=D.unstable_now(),typeof y=="function"?ee.callback=y:ee===m(Q)&&ve(Q),Je(_)}else ve(Q);ee=m(Q)}if(ee!==null)var F=!0;else{var R=m(Le);R!==null&&re(we,R.startTime-_),F=!1}return F}finally{ee=null,Y=k,Qe=!1}}var Se=!1,_e=null,Ve=-1,Pt=5,vt=-1;function $t(){return!(D.unstable_now()-vt<Pt)}function st(){if(_e!==null){var x=D.unstable_now();vt=x;var _=!0;try{_=_e(!0,x)}finally{_?Ae():(Se=!1,_e=null)}}else Se=!1}var Ae;if(typeof at=="function")Ae=function(){at(st)};else if(typeof MessageChannel<"u"){var et=new MessageChannel,dt=et.port2;et.port1.onmessage=st,Ae=function(){dt.postMessage(null)}}else Ae=function(){H(st,0)};function Te(x){_e=x,Se||(Se=!0,Ae())}function re(x,_){Ve=H(function(){x(D.unstable_now())},_)}D.unstable_IdlePriority=5,D.unstable_ImmediatePriority=1,D.unstable_LowPriority=4,D.unstable_NormalPriority=3,D.unstable_Profiling=null,D.unstable_UserBlockingPriority=2,D.unstable_cancelCallback=function(x){x.callback=null},D.unstable_continueExecution=function(){He||Qe||(He=!0,Te(be))},D.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Pt=0<x?Math.floor(1e3/x):5},D.unstable_getCurrentPriorityLevel=function(){return Y},D.unstable_getFirstCallbackNode=function(){return m(Q)},D.unstable_next=function(x){switch(Y){case 1:case 2:case 3:var _=3;break;default:_=Y}var k=Y;Y=_;try{return x()}finally{Y=k}},D.unstable_pauseExecution=function(){},D.unstable_requestPaint=function(){},D.unstable_runWithPriority=function(x,_){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var k=Y;Y=x;try{return _()}finally{Y=k}},D.unstable_scheduleCallback=function(x,_,k){var d=D.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?d+k:d):k=d,x){case 1:var y=-1;break;case 2:y=250;break;case 5:y=1073741823;break;case 4:y=1e4;break;default:y=5e3}return y=k+y,x={id:ge++,callback:_,priorityLevel:x,startTime:k,expirationTime:y,sortIndex:-1},k>d?(x.sortIndex=k,B(Le,x),m(Q)===null&&x===m(Le)&&(X?(yt(Ve),Ve=-1):X=!0,re(we,k-d))):(x.sortIndex=y,B(Q,x),He||Qe||(He=!0,Te(be))),x},D.unstable_shouldYield=$t,D.unstable_wrapCallback=function(x){var _=Y;return function(){var k=Y;Y=_;try{return x.apply(this,arguments)}finally{Y=k}}}})(Cl)),Cl}var Is;function zf(){return Is||(Is=1,Pl.exports=Ff()),Pl.exports}/**
 * @license React
...
`},{id:1,question:"",answer:"",codeExample:""},{id:1,question:"",answer:"",codeExample:""},{id:1,question:"",answer:"",codeExample:""}],ve=U=>{B(D===U?null:U)};return Ie.jsxs("div",{className:"app-container",children:[Ie.jsx("h1",{children:"DSA Interview Questions"}),Ie.jsx("div",{className:"questions-container",children:m.map(U=>Ie.jsxs("div",{className:"question-item",children:[Ie.jsx("button",{className:`question-button ${D===U.id?"active":""}`,onClick:()=>ve(U.id),children:U.question}),D===U.id&&Ie.jsxs("div",{className:"answer-container",children:[Ie.jsxs("div",{className:"answer",children:[Ie.jsx("h3",{children:"Answer:"}),Ie.jsx("p",{children:U.answer})]}),U.codeExample&&Ie.jsxs("div",{className:"code-example",children:[Ie.jsx("h3",{children:"Code Example:"}),Ie.jsx("pre",{children:Ie.jsx("code",{children:U.codeExample})})]})]})]},U.id))})]})}Of.createRoot(document.getElementById("root")).render(Ie.jsx(Us.StrictMode,{children:Ie.jsx(qf,{})}));
